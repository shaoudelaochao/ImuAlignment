...
public:
	...
	friend CVect3 double2Cvect3(const double a[3]);
};
...
public:
	...
	void UpdateCnscl(const IMUObs_t *imudata, int nSamples, double &nts);
...
public:
	...
	void UpdateSins(const IMUObs_t *imudata, int nSamples, double &nts);
...
//	CVectf Zfd, Zfd0, Zmm0, RtTau, Rmax, measstop, measlost, Rmin, Rb, Rstop, Rbeta;
	...
	//void SetFt(int nnq) ;			// process matrix setting
	//void SetHk(int nnq) ;			// measurement matrix setting
	//void SetMeas(void) ;				// set measurement
	//void Feedback(int nnq, double fbts);	// state feedback
	//											//
